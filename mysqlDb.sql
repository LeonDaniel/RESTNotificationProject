...
CREATE  TABLE `messages`.`NOTIFICATIONS` (
  ...
  `RESOURCE_INFO` VARCHAR(100) NOT NULL ,
  `FK_ID_TOPIC` INT NOT NULL ,
  `MSG_NR` INT NOT NULL ,
...
INSERT INTO `messages`.`TOPICS` (`DENUMIRE`, `INSERTDATE`) VALUES ('topic1', NOW()); 
...
INSERT INTO `messages`.`NOTIFICATIONS` (`FK_ID_USER`,`RESOURCE_INFO`,`FK_ID_TOPIC`,`MSG_NR`,`STATUS`) VALUES (1,'10.0.0.1',1,5,'pending');
INSERT INTO `messages`.`NOTIFICATIONS` (`FK_ID_USER`,`RESOURCE_INFO`,`FK_ID_TOPIC`,`MSG_NR`,`STATUS`) VALUES (2,'10.0.0.1',1,5,'pending');
INSERT INTO `messages`.`NOTIFICATIONS` (`FK_ID_USER`,`RESOURCE_INFO`,`FK_ID_TOPIC`,`MSG_NR`,`STATUS`) VALUES (3,'10.0.0.1',1,5,'pending');
