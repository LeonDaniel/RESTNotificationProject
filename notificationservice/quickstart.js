...
Request('GET','/MESSAGE/general/interest/topic?data=1','marius','marius',null,function(resp){ console.log('Reading a message: '+resp);
...
Request('GET','/MESSAGE/general/interest/topic?data=1','marius','marius',null,function(resp){ console.log('Reading a modified message: '+resp);
